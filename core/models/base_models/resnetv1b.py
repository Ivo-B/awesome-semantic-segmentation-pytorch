...
def resnet50_v1s(pretrained=False, root='../runs/models', **kwargs):
...
def resnet101_v1s(pretrained=False, root='../runs/models', **kwargs):
...
def resnet152_v1s(pretrained=False, root='../runs/models', **kwargs):
